		...
		extend: {
			colors: {
				...
				energy: {
					...
					particle: 'hsl(var(--energy-particle))',
					aura: 'hsl(var(--energy-aura))'
				}
			},
			fontFamily: {
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': { boxShadow: '0 0 20px hsl(var(--energy-glow) / 0.3)' },
					'50%': { boxShadow: '0 0 40px hsl(var(--energy-glow) / 0.6)' }
				}
			},
			animation: {
