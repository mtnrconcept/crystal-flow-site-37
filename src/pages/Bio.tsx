          ...
          <div className="container mx-auto max-w-4xl">
            <div className="space-y-8 text-lg leading-relaxed">
              <p className="text-foreground/90">
                Je pratique le Reiki, le magnétisme et l'harmonisation depuis plusieurs années. 
                Mon approche est simple : écoute, précision, sécurité. Les séances sont adaptées 
                à chaque personne, avec des conseils d'intégration après le soin.
              </p>
              
              <p className="text-muted-foreground">
                Formé dans différentes traditions énergétiques, j'ai développé une méthode 
                qui honore la singularité de chaque personne tout en respectant les principes 
                fondamentaux de ces pratiques ancestrales.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="relative">
                <div className="w-80 h-80 mx-auto">
                  ...
                  <svg className="absolute inset-0 w-full h-full text-primary/20" viewBox="0 0 300 300">
                    <path 
                      d="M150 50c40 20 60 60 50 100-10 30-50 40-70 30-15-8-20-30-10-44 15-20 40-15 50-4" 
                      stroke="currentColor" 
                      strokeWidth="2" 
                      fill="none"
